...
export default function PropertyFormPage() {
  ...
  const handleFormSubmit = (formData: PropertyFormData) => {
    ...
    const validFormData = formData as PropertyData;
    ...
    const submitData: PropertySubmitData = {
      ...
      bedrooms: validFormData.bedrooms,
      bathrooms: validFormData.bathrooms,
      sqft: validFormData.sqft,
      livingArea: validFormData.livingArea,
      buildYear: validFormData.buildYear,
      garages: validFormData.garages,
      energyLabel: validFormData.energyLabel,
      hasGarden: validFormData.hasGarden,
      description: validFormData.description,
      location_description: validFormData.location_description,
      floorplans: validFormData.floorplans,
      featuredImage: validFormData.featuredImage,
      gridImages: validFormData.gridImages,
      areaPhotos: validFormData.areaPhotos,
      features: validFormData.features as unknown as Json,
      areas: validFormData.areas as unknown as Json[],
      nearby_places: validFormData.nearby_places as unknown as Json,
      images: validFormData.images.map(img => img.url),
      latitude: validFormData.latitude,
      longitude: validFormData.longitude,
      object_id: validFormData.object_id,
      map_image: validFormData.map_image,
      agent_id: selectedAgent || null
    };
